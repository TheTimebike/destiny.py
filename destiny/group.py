...
class Group:
    ...
    async def get_admins_and_founder(self):
        """*This function is a coroutine*

        A coroutine that returns a list of GroupMember objects from a groupID for the admins and founders of a group. Returns an empty list if not found.
